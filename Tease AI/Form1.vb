...
retryit:
		...
		Catch ex As Exception
			Log.WriteError(ex.Message, ex, "Error on startup")
			Dim b As MsgBoxResult =
					MessageBox.Show("Error on startup occured. Tease-AI is unable to work properly until this error is fixed." &
									vbCrLf & vbCrLf &
									ex.Message &
									vbCrLf & vbCrLf &
									"See the Error Log for further details.", "Startup failed",
